---
ai_context: Auto-fetched NVDA user guide. Supporting provenance source for the curated
  NVDA testing guides.
domain:
- web
- general
...
- [NVDA 2025.3.3 User Guide](#nvda-202533-user-guide "NVDA 2025.3.3 User Guide")
  - [Introduction](#Introduction "Introduction")
    - [General Features](#GeneralFeatures "General Features")
    - [System Requirements](#SystemRequirements "System Requirements")
      - [Minimum System Requirements](#MinimumSystemRequirements "Minimum System Requirements")
      - [Recommended System Requirements](#RecommendedSystemRequirements "Recommended System Requirements")
    - [Internationalization](#Internationalization "Internationalization")
    - [Speech Synthesizer Support](#SpeechSynthesizerSupport "Speech Synthesizer Support")
    - [Braille support](#BrailleSupport "Braille support")
    - [License and Copyright](#LicenseAndCopyright "License and Copyright")
  - [NVDA Quick Start Guide](#NVDAQuickStartGuide "NVDA Quick Start Guide")
    - [Downloading NVDA](#GettingAndSettingUpNVDA "Downloading NVDA")
      - [Steps for Downloading NVDA](#StepsForDownloadingNVDA "Steps for Downloading NVDA")
    - [Setting up NVDA](#SettingUpNVDA "Setting up NVDA")
      - [Steps for running the downloaded launcher](#StepsForRunningTheDownloadLauncher "Steps for running the downloaded launcher")
      - [Steps for installing NVDA from the launcher](#StepsForInstallingNVDAFromTheLauncher "Steps for installing NVDA from the launcher")
    - [Running NVDA](#RunningNVDA "Running NVDA")
      - [The NVDA Modifier Key](#NVDAModifierKey "The NVDA Modifier Key")
      - [Input Help](#InputHelp "Input Help")
      - [Starting and stopping NVDA](#StartingAndStoppingNVDA "Starting and stopping NVDA")
      - [Reading text](#ReadingText "Reading text")
      - [Reporting location and other information](#ReportingLocation "Reporting location and other information")
      - [Toggle which information NVDA reads](#ToggleWhichInformationNVDAReads "Toggle which information NVDA reads")
      - [The synth settings ring](#TheSynthSettingsRing "The synth settings ring")
      - [Web navigation](#WebNavigation "Web navigation")
    - [Preferences](#Preferences "Preferences")
    - [Add-ons](#Addons "Add-ons")
      - [Available add-ons](#AvailableAddons "Available add-ons")
      - [Searching for add-ons](#SearchingForAddons "Searching for add-ons")
      - [Installing add-ons](#InstallingAddons "Installing add-ons")
      - [Managing installed add-ons](#ManagingInstalledAddons "Managing installed add-ons")
      - [Updating add-ons](#UpdatingAddons "Updating add-ons")
    - [Community](#Community "Community")
    - [Getting help](#GettingHelp "Getting help")
  - [More Setup Options](#MoreSetupOptions "More Setup Options")
    - [Installation Options](#InstallingNVDA "Installation Options")
      - [Incompatible add-ons warning](#InstallWithIncompatibleAddons "Incompatible add-ons warning")
      - [Use NVDA during sign-in](#StartAtWindowsLogon "Use NVDA during sign-in")
      - [Create Desktop Shortcut (ctrl+alt+n)](#CreateDesktopShortcut "Create Desktop Shortcut (ctrl+alt+n)")
      - [Copy Portable Configuration to Current User Account](#CopyPortableConfigurationToCurrentUserAccount "Copy Portable Configuration to Current User Account")
    - [Creating a Portable Copy](#CreatingAPortableCopy "Creating a Portable Copy")
    - [Portable and Temporary Copy Restrictions](#PortableAndTemporaryCopyRestrictions "Portable and Temporary Copy Restrictions")
  - [Using NVDA](#GettingStartedWithNVDA "Using NVDA")
    - [Launching NVDA](#LaunchingNVDA "Launching NVDA")
      - [Welcome Dialog](#WelcomeDialog "Welcome Dialog")
      - [Data usage statistics dialog](#UsageStatsDialog "Data usage statistics dialog")
    - [About NVDA keyboard commands](#AboutNVDAKeyboardCommands "About NVDA keyboard commands")
      - [The NVDA Modifier Key](#TheNVDAModifierKey "The NVDA Modifier Key")
      - [Keyboard Layouts](#KeyboardLayouts "Keyboard Layouts")
    - [NVDA Touch Gestures](#NVDATouchGestures "NVDA Touch Gestures")
      - [Exploring the Screen](#ExploringTheScreen "Exploring the Screen")
      - [Touch Gestures](#TouchGestures "Touch Gestures")
        - [Taps](#Taps "Taps")
        - [Flicks](#Flicks "Flicks")
      - [Touch Modes](#TouchModes "Touch Modes")
      - [Touch keyboard](#TouchKeyboard "Touch keyboard")
    - [Input Help Mode](#InputHelpMode "Input Help Mode")
    - [The NVDA menu](#TheNVDAMenu "The NVDA menu")
    - [Basic NVDA commands](#BasicNVDACommands "Basic NVDA commands")
    - [Reporting System Information](#ReportingSystemInformation "Reporting System Information")
    - [Speech modes](#SpeechModes "Speech modes")
  - [Navigating with NVDA](#NavigatingWithNVDA "Navigating with NVDA")
    - [Objects](#Objects "Objects")
    - [Navigating with the System Focus](#SystemFocus "Navigating with the System Focus")
    - [Navigating with the System Caret](#SystemCaret "Navigating with the System Caret")
    - [Object Navigation](#ObjectNavigation "Object Navigation")
    - [Reviewing Text](#ReviewingText "Reviewing Text")
    - [Review Modes](#ReviewModes "Review Modes")
      - [Object Review](#ObjectReview "Object Review")
      - [Document Review](#DocumentReview "Document Review")
      - [Screen Review](#ScreenReview "Screen Review")
    - [Navigating with the Mouse](#NavigatingWithTheMouse "Navigating with the Mouse")
  - [Browse Mode](#BrowseMode "Browse Mode")
    - [Single Letter Navigation](#SingleLetterNavigation "Single Letter Navigation")
      - [Text paragraph navigation command](#TextNavigationCommand "Text paragraph navigation command")
      - [Other navigation commands](#OtherNavigationCommands "Other navigation commands")
    - [The Elements List](#ElementsList "The Elements List")
    - [Searching for text](#SearchingForText "Searching for text")
    - [Embedded Objects](#ImbeddedObjects "Embedded Objects")
    - [Native Selection Mode](#NativeSelectionMode "Native Selection Mode")
  - [Reading Mathematical Content](#ReadingMath "Reading Mathematical Content")
    - [Supported math content](#SupportedMathContent "Supported math content")
    - [Interactive Navigation](#InteractiveNavigation "Interactive Navigation")
    - [Installing MathPlayer](#InstallingMathPlayer "Installing MathPlayer")
  - [Braille](#Braille "Braille")
    - [Control Type, State and Landmark abbreviations](#BrailleAbbreviations "Control Type, State and Landmark abbreviations")
    - [Braille Input](#BrailleInput "Braille Input")
      - [Inputting keyboard shortcuts](#BrailleKeyboardShortcuts "Inputting keyboard shortcuts")
  - [Vision](#Vision "Vision")
    - [Visual Highlight](#VisionFocusHighlight "Visual Highlight")
    - [Screen Curtain](#VisionScreenCurtain "Screen Curtain")
  - [Content Recognition](#ContentRecognition "Content Recognition")
    - [Windows OCR](#Win10Ocr "Windows OCR")
  - [Application Specific Features](#ApplicationSpecificFeatures "Application Specific Features")
    - [Microsoft Word](#MicrosoftWord "Microsoft Word")
      - [Automatic Column and Row Header Reading](#WordAutomaticColumnAndRowHeaderReading "Automatic Column and Row Header Reading")
      - [Browse Mode in Microsoft Word](#BrowseModeInMicrosoftWord "Browse Mode in Microsoft Word")
        - [The Elements List](#WordElementsList "The Elements List")
      - [Reporting Comments](#WordReportingComments "Reporting Comments")
    - [Microsoft Excel](#MicrosoftExcel "Microsoft Excel")
      - [Automatic Column and Row Header Reading](#ExcelAutomaticColumnAndRowHeaderReading "Automatic Column and Row Header Reading")
      - [The Elements List](#ExcelElementsList "The Elements List")
      - [Reporting Notes](#ExcelReportingComments "Reporting Notes")
      - [Reading Protected Cells](#ExcelReadingProtectedCells "Reading Protected Cells")
      - [Form Fields](#ExcelFormFields "Form Fields")
    - [Microsoft PowerPoint](#MicrosoftPowerPoint "Microsoft PowerPoint")
    - [foobar2000](#Foobar2000 "foobar2000")
    - [Miranda IM](#MirandaIM "Miranda IM")
    - [Poedit](#Poedit "Poedit")
    - [Kindle for PC](#Kindle "Kindle for PC")
      - [Text Selection](#KindleTextSelection "Text Selection")
      - [User Notes](#KindleUserNotes "User Notes")
    - [Azardi](#Azardi "Azardi")
    - [Windows Console](#WinConsole "Windows Console")
  - [Configuring NVDA](#ConfiguringNVDA "Configuring NVDA")
    - [NVDA Settings](#NVDASettings "NVDA Settings")
      - [General](#GeneralSettings "General")
        - [Open General settings](#OpenGeneralSettings "Open General settings")
        - [Language](#GeneralSettingsLanguage "Language")
        - [Save configuration on exit](#GeneralSettingsSaveConfig "Save configuration on exit")
        - [Show exit options when exiting NVDA](#GeneralSettingsShowExitOptions "Show exit options when exiting NVDA")
        - [Play sounds when starting or exiting NVDA](#GeneralSettingsPlaySounds "Play sounds when starting or exiting NVDA")
        - [Logging level](#GeneralSettingsLogLevel "Logging level")
        - [Start NVDA after I sign in](#GeneralSettingsStartAfterLogOn "Start NVDA after I sign in")
        - [Use NVDA during sign-in (requires administrator privileges)](#GeneralSettingsStartOnLogOnScreen "Use NVDA during sign-in (requires administrator privileges)")
        - [Use currently saved settings during sign-in and on secure screens (requires administrator privileges)](#GeneralSettingsCopySettings "Use currently saved settings during sign-in and on secure screens (requires administrator privileges)")
        - [Automatically check for updates to NVDA](#GeneralSettingsCheckForUpdates "Automatically check for updates to NVDA")
        - [Allow NV Access to gather NVDA usage statistics](#GeneralSettingsGatherUsageStats "Allow NV Access to gather NVDA usage statistics")
        - [Notify for pending updates on startup](#GeneralSettingsNotifyPendingUpdates "Notify for pending updates on startup")
        - [Update Mirror](#UpdateMirror "Update Mirror")
        - [Prevent display from turning off during say all or reading with braille](#PreventDisplayTurningOff "Prevent display from turning off during say all or reading with braille")
      - [Speech Settings](#SpeechSettings "Speech Settings")
        - [Open Speech settings](#OpenSpeechSettings "Open Speech settings")
        - [Change synthesizer](#SpeechSettingsChange "Change synthesizer")
        - [Voice](#SpeechSettingsVoice "Voice")
        - [Variant](#SpeechSettingsVariant "Variant")
        - [Rate](#SpeechSettingsRate "Rate")
        - [Rate boost](#SpeechSettingsRateBoost "Rate boost")
        - [Pitch](#SpeechSettingsPitch "Pitch")
        - [Volume](#SpeechSettingsVolume "Volume")
        - [Inflection](#SpeechSettingsInflection "Inflection")
        - [Use modern audio output system (WASAPI)](#SpeechSettingsUseWasapi "Use modern audio output system (WASAPI)")
        - [Automatic Language switching](#SpeechSettingsLanguageSwitching "Automatic Language switching")
        - [Automatic Dialect switching](#SpeechSettingsDialectSwitching "Automatic Dialect switching")
        - [Report language changes while reading](#ReportLanguage "Report language changes while reading")
        - [Report when switching to language is not supported by synthesizer](#ReportIfLanguageIsNotSupportedBySynthesizer "Report when switching to language is not supported by synthesizer")
        - [Punctuation/Symbol Level](#SpeechSettingsSymbolLevel "Punctuation/Symbol Level")
        - [Trust voice's language when processing characters and symbols](#SpeechSettingsTrust "Trust voice's language when processing characters and symbols")
        - [Unicode normalization](#SpeechUnicodeNormalization "Unicode normalization")
        - [Report "Normalized" when navigating by character](#SpeechReportNormalizedForCharacterNavigation "Report \"Normalized\" when navigating by character")
        - [Include Unicode Consortium data (including emoji) when processing characters and symbols](#SpeechSettingsCLDR "Include Unicode Consortium data (including emoji) when processing characters and symbols")
        - [Capital pitch change percentage](#SpeechSettingsCapPitchChange "Capital pitch change percentage")
        - [Say "cap" before capitals](#SpeechSettingsSayCapBefore "Say \"cap\" before capitals")
        - [Beep for capitals](#SpeechSettingsBeepForCaps "Beep for capitals")
        - [Use spelling functionality if supported](#SpeechSettingsUseSpelling "Use spelling functionality if supported")
        - [Delayed descriptions for characters on cursor movement](#delayedCharacterDescriptions "Delayed descriptions for characters on cursor movement")
        - [Modes available in the Cycle speech mode command](#SpeechModesDisabling "Modes available in the Cycle speech mode command")
      - [Select Synthesizer](#SelectSynthesizer "Select Synthesizer")
        - [Open Select Synthesizer dialog](#OpenSelectSynthesizer "Open Select Synthesizer dialog")
        - [Synthesizer](#SelectSynthesizerSynthesizer "Synthesizer")
      - [Synth settings ring](#SynthSettingsRing "Synth settings ring")
      - [Braille](#BrailleSettings "Braille")
        - [Change braille display](#BrailleSettingsChange "Change braille display")
        - [Output Table](#BrailleSettingsOutputTable "Output Table")
        - [Input Table](#BrailleSettingsInputTable "Input Table")
        - [Braille mode](#BrailleMode "Braille mode")
        - [Expand to computer braille for the word at the cursor](#BrailleSettingsExpandToComputerBraille "Expand to computer braille for the word at the cursor")
        - [Show Cursor](#BrailleSettingsShowCursor "Show Cursor")
        - [Blink Cursor](#BrailleSettingsBlinkCursor "Blink Cursor")
        - [Cursor Blink Rate (ms)](#BrailleSettingsBlinkRate "Cursor Blink Rate (ms)")
        - [Cursor Shape for Focus](#BrailleSettingsCursorShapeForFocus "Cursor Shape for Focus")
        - [Cursor Shape for Review](#BrailleSettingsCursorShapeForReview "Cursor Shape for Review")
        - [Show Messages](#BrailleSettingsShowMessages "Show Messages")
        - [Message Timeout (sec)](#BrailleSettingsMessageTimeout "Message Timeout (sec)")
        - [Tether Braille](#BrailleTether "Tether Braille")
        - [Move system caret when routing review cursor](#BrailleSettingsReviewRoutingMovesSystemCaret "Move system caret when routing review cursor")
        - [Read by Paragraph](#BrailleSettingsReadByParagraph "Read by Paragraph")
        - [Paragraph start marker](#BrailleParagraphStartMarkers "Paragraph start marker")
        - [Focus context presentation](#BrailleSettingsFocusContextPresentation "Focus context presentation")
        - [Show selection](#BrailleSettingsShowSelection "Show selection")
        - [Formatting display](#BrailleFormattingDisplay "Formatting display")
          - [Tags](#BrailleFormattingDisplayTags "Tags")
        - [Speak character when routing cursor in text](#BrailleSpeakOnRouting "Speak character when routing cursor in text")
        - [Speak when navigating by line or paragraph](#BrailleSpeakOnNavigating "Speak when navigating by line or paragraph")
        - [Avoid splitting words when possible](#BrailleSettingsWordWrap "Avoid splitting words when possible")
        - [Unicode normalization](#BrailleUnicodeNormalization "Unicode normalization")
        - [Interrupt speech while scrolling](#BrailleSettingsInterruptSpeech "Interrupt speech while scrolling")
      - [Select Braille Display](#SelectBrailleDisplay "Select Braille Display")
        - [Open Select Braille Display dialog](#OpenSelectBrailleDisplay "Open Select Braille Display dialog")
        - [Braille Display](#SelectBrailleDisplayDisplay "Braille Display")
        - [Displays to detect automatically](#SelectBrailleDisplayAutoDetect "Displays to detect automatically")
        - [Port](#SelectBrailleDisplayPort "Port")
      - [Audio](#AudioSettings "Audio")
        - [Open Audio settings](#OpenAudioSettings "Open Audio settings")
        - [Output device](#SelectSynthesizerOutputDevice "Output device")
        - [Audio Ducking Mode](#SelectSynthesizerDuckingMode "Audio Ducking Mode")
        - [Volume of NVDA sounds follows voice volume](#SoundVolumeFollowsVoice "Volume of NVDA sounds follows voice volume")
        - [Volume of NVDA sounds](#SoundVolume "Volume of NVDA sounds")
        - [Sound split](#SelectSoundSplitMode "Sound split")
        - [Customizing Sound split modes](#CustomizeSoundSplitModes "Customizing Sound split modes")
        - [Time to keep audio device awake after speech](#AudioAwakeTime "Time to keep audio device awake after speech")
      - [Vision](#VisionSettings "Vision")
        - [Visual Highlight](#VisionSettingsFocusHighlight "Visual Highlight")
        - [Screen Curtain](#VisionSettingsScreenCurtain "Screen Curtain")
        - [Settings for third party visual aids](#VisionSettingsThirdPartyVisualAids "Settings for third party visual aids")
      - [Keyboard](#KeyboardSettings "Keyboard")
        - [Open Keyboard settings](#OpenKeyboardSettings "Open Keyboard settings")
        - [Keyboard layout](#KeyboardSettingsLayout "Keyboard layout")
        - [Select NVDA Modifier Keys](#KeyboardSettingsModifiers "Select NVDA Modifier Keys")
        - [Speak Typed Characters](#KeyboardSettingsSpeakTypedCharacters "Speak Typed Characters")
        - [Speak Typed Words](#KeyboardSettingsSpeakTypedWords "Speak Typed Words")
        - [Speech interrupt for typed characters](#KeyboardSettingsSpeechInteruptForCharacters "Speech interrupt for typed characters")
        - [Speech interrupt for Enter key](#KeyboardSettingsSpeechInteruptForEnter "Speech interrupt for Enter key")
        - [Allow skim reading in Say All](#KeyboardSettingsSkimReading "Allow skim reading in Say All")
        - [Beep if Typing Lowercase Letters when Caps Lock is On](#KeyboardSettingsBeepLowercase "Beep if Typing Lowercase Letters when Caps Lock is On")
        - [Speak Command Keys](#KeyboardSettingsSpeakCommandKeys "Speak Command Keys")
        - [Play sound for spelling errors while typing](#KeyboardSettingsAlertForSpellingErrors "Play sound for spelling errors while typing")
        - [Handle keys from other applications](#KeyboardSettingsHandleKeys "Handle keys from other applications")
        - [Multiple key press timeout](#MultiPressTimeout "Multiple key press timeout")
      - [Mouse](#MouseSettings "Mouse")
        - [Open Mouse settings](#OpenMouseSettings "Open Mouse settings")
        - [Report Mouse Shape Changes](#MouseSettingsShape "Report Mouse Shape Changes")
        - [Enable mouse tracking](#MouseSettingsTracking "Enable mouse tracking")
        - [Text unit resolution](#MouseSettingsTextUnit "Text unit resolution")
        - [Report object when mouse enters it](#MouseSettingsRole "Report object when mouse enters it")
        - [Play audio coordinates when mouse moves](#MouseSettingsAudio "Play audio coordinates when mouse moves")
        - [Brightness controls audio coordinates volume](#MouseSettingsBrightness "Brightness controls audio coordinates volume")
        - [Ignore mouse input from other applications](#MouseSettingsHandleMouseControl "Ignore mouse input from other applications")
      - [Touch Interaction](#TouchInteraction "Touch Interaction")
        - [Enable touch interaction support](#TouchSupportEnable "Enable touch interaction support")
        - [Touch typing mode](#TouchTypingMode "Touch typing mode")
      - [Review Cursor](#ReviewCursorSettings "Review Cursor")
        - [Follow System Focus](#ReviewCursorFollowFocus "Follow System Focus")
        - [Follow System Caret](#ReviewCursorFollowCaret "Follow System Caret")
        - [Follow mouse cursor](#ReviewCursorFollowMouse "Follow mouse cursor")
        - [Simple Review mode](#ReviewCursorSimple "Simple Review mode")
      - [Object Presentation](#ObjectPresentationSettings "Object Presentation")
        - [Open Object Presentation settings](#OpenObjectPresentationSettings "Open Object Presentation settings")
        - [Report tooltips](#ObjectPresentationReportToolTips "Report tooltips")
        - [Report notifications](#ObjectPresentationReportNotifications "Report notifications")
        - [Report Object Shortcut Keys](#ObjectPresentationShortcutKeys "Report Object Shortcut Keys")
        - [Report object position information](#ObjectPresentationPositionInfo "Report object position information")
        - [Guess Object Position Information when unavailable](#ObjectPresentationGuessPositionInfo "Guess Object Position Information when unavailable")
        - [Report Object descriptions](#ObjectPresentationReportDescriptions "Report Object descriptions")
        - [Progress bar output](#ObjectPresentationProgressBarOutput "Progress bar output")
        - [Report background progress bars](#ObjectPresentationReportBackgroundProgressBars "Report background progress bars")
        - [Report dynamic content changes](#ObjectPresentationReportDynamicContent "Report dynamic content changes")
        - [Play a sound when auto-suggestions appear](#ObjectPresentationSuggestionSounds "Play a sound when auto-suggestions appear")
      - [Input Composition](#InputCompositionSettings "Input Composition")
        - [Automatically report all available candidates](#InputCompositionReportAllCandidates "Automatically report all available candidates")
        - [Announce Selected Candidate](#InputCompositionAnnounceSelectedCandidate "Announce Selected Candidate")
        - [Always include short character descriptions for candidates](#InputCompositionCandidateIncludesShortCharacterDescription "Always include short character descriptions for candidates")
        - [Report changes to the reading string](#InputCompositionReadingStringChanges "Report changes to the reading string")
        - [Report changes to the composition string](#InputCompositionCompositionStringChanges "Report changes to the composition string")
      - [Browse Mode](#BrowseModeSettings "Browse Mode")
        - [Open Browse Mode settings](#OpenBrowseModeSettings "Open Browse Mode settings")
        - [Maximum Number of Characters on One Line](#BrowseModeSettingsMaxLength "Maximum Number of Characters on One Line")
        - [Maximum Lines Per Page](#BrowseModeSettingsPageLines "Maximum Lines Per Page")
        - [Use screen layout](#BrowseModeSettingsScreenLayout "Use screen layout")
        - [Enable browse mode on page load](#BrowseModeSettingsEnableOnPageLoad "Enable browse mode on page load")
        - [Automatic Say All on page load](#BrowseModeSettingsAutoSayAll "Automatic Say All on page load")
        - [Include layout tables](#BrowseModeSettingsIncludeLayoutTables "Include layout tables")
        - [Configuring reporting of fields such as links and headings](#BrowseModeLinksAndHeadings "Configuring reporting of fields such as links and headings")
        - [Automatic focus mode for focus changes](#BrowseModeSettingsAutoPassThroughOnFocusChange "Automatic focus mode for focus changes")
        - [Automatic focus mode for caret movement](#BrowseModeSettingsAutoPassThroughOnCaretMove "Automatic focus mode for caret movement")
        - [Audio indication of Focus and Browse modes](#BrowseModeSettingsPassThroughAudioIndication "Audio indication of Focus and Browse modes")
        - [Trap non-command gestures from reaching the document](#BrowseModeSettingsTrapNonCommandGestures "Trap non-command gestures from reaching the document")
      - [Document Formatting](#DocumentFormattingSettings "Document Formatting")
        - [Open Document Formatting settings](#OpenDocumentFormattingSettings "Open Document Formatting settings")
        - [Font attributes](#DocumentFormattingFontAttributes "Font attributes")
        - [Report formatting changes after the cursor](#DocumentFormattingDetectFormatAfterCursor "Report formatting changes after the cursor")
        - [Line indentation reporting](#DocumentFormattingSettingsLineIndentation "Line indentation reporting")
      - [Document Navigation](#DocumentNavigation "Document Navigation")
        - [Paragraph Style](#ParagraphStyle "Paragraph Style")
      - [Add-on Store Settings](#AddonStoreSettings "Add-on Store Settings")
        - [Automatic updates](#AutomaticAddonUpdates "Automatic updates")
        - [Default Update Channel](#DefaultAddonUpdateChannel "Default Update Channel")
        - [Allow automatic updates to install incompatible add-ons](#AllowIncompatibleAddonUpdates "Allow automatic updates to install incompatible add-ons")
        - [Mirror server](#AddonStoreMetadataMirror "Mirror server")
      - [Remote Access Settings](#RemoteSettings "Remote Access Settings")
        - [Enable Remote Access](#RemoteEnable "Enable Remote Access")
        - [Confirm before disconnecting when controlled](#RemoteConfirmDisconnect "Confirm before disconnecting when controlled")
        - [Mute when controlling the local computer](#RemoteMuteOnLocalControl "Mute when controlling the local computer")
        - [Automatically connect after NVDA starts](#RemoteAutoconnect "Automatically connect after NVDA starts")
        - [Mode](#RemoteAutoconnectMode "Mode")
        - [Server](#RemoteAutoconnectServer "Server")
        - [Host](#RemoteAutoconnectHost "Host")
        - [Port](#RemoteAutoconnectPort "Port")
        - [Key](#RemoteAutoconnectKey "Key")
        - [Delete all trusted fingerprints](#RemoteDeleteFingerprints "Delete all trusted fingerprints")
      - [Windows OCR Settings](#Win10OcrSettings "Windows OCR Settings")
        - [Recognition language](#Win10OcrSettingsRecognitionLanguage "Recognition language")
        - [Periodically refresh recognized content](#Win10OcrSettingsAutoRefresh "Periodically refresh recognized content")
      - [Set Mirror Dialog](#SetURLDialog "Set Mirror Dialog")
        - [URL](#SetURLTextbox "URL")
        - [Test...](#SetURLTest "Test...")
      - [Advanced Settings](#AdvancedSettings "Advanced Settings")
        - [Making changes to advanced settings](#AdvancedSettingsMakingChanges "Making changes to advanced settings")
        - [Restoring the default settings](#AdvancedSettingsRestoringDefaults "Restoring the default settings")
        - [Enable loading custom code from Developer Scratchpad Directory](#AdvancedSettingsEnableScratchpad "Enable loading custom code from Developer Scratchpad Directory")
        - [Open Developer Scratchpad Directory](#AdvancedSettingsOpenScratchpadDir "Open Developer Scratchpad Directory")
        - [Registration for UI Automation events and property changes](#AdvancedSettingsSelectiveUIAEventRegistration "Registration for UI Automation events and property changes")
        - [Use UI automation to access Microsoft Word document controls](#MSWordUIA "Use UI automation to access Microsoft Word document controls")
        - [Use UI automation to access Microsoft Excel spreadsheet controls when available](#UseUiaForExcel "Use UI automation to access Microsoft Excel spreadsheet controls when available")
        - [Use enhanced event processing](#UIAEnhancedEventProcessing "Use enhanced event processing")
        - [Windows Console support](#AdvancedSettingsConsoleUIA "Windows Console support")
        - [Use UIA with Microsoft Edge and other Chromium based browsers when available](#ChromiumUIA "Use UIA with Microsoft Edge and other Chromium based browsers when available")
        - [Annotations](#Annotations "Annotations")
        - [Report live regions](#BrailleLiveRegions "Report live regions")
        - [Speak passwords in all enhanced terminals](#AdvancedSettingsWinConsoleSpeakPasswords "Speak passwords in all enhanced terminals")
        - [Use enhanced typed character support in legacy Windows Console when available](#AdvancedSettingsKeyboardSupportInLegacy "Use enhanced typed character support in legacy Windows Console when available")
        - [Diff algorithm](#DiffAlgo "Diff algorithm")
        - [Speak new text in Windows Terminal via](#WtStrategy "Speak new text in Windows Terminal via")
        - [Attempt to cancel speech for expired focus events](#CancelExpiredFocusSpeech "Attempt to cancel speech for expired focus events")
        - [Trim leading silence in speech audio](#TrimLeadingSilenceSpeech "Trim leading silence in speech audio")
        - [Use WASAPI for SAPI 4 audio output](#UseWASAPIForSAPI4 "Use WASAPI for SAPI 4 audio output")
        - [Caret move timeout (in MS)](#AdvancedSettingsCaretMoveTimeout "Caret move timeout (in MS)")
        - [Report transparency for colors](#ReportTransparentColors "Report transparency for colors")
        - [Debug logging categories](#AdvancedSettingsDebugLoggingCategories "Debug logging categories")
        - [Play a sound for logged errors](#PlayErrorSound "Play a sound for logged errors")
        - [Regular expression for text paragraph quick navigation commands](#TextParagraphRegexEdit "Regular expression for text paragraph quick navigation commands")
    - [miscellaneous Settings](#MiscSettings "miscellaneous Settings")
      - [Speech dictionaries](#SpeechDictionaries "Speech dictionaries")
      - [Punctuation/symbol pronunciation](#SymbolPronunciation "Punctuation/symbol pronunciation")
      - [Input Gestures](#InputGestures "Input Gestures")
    - [Saving and Reloading the configuration](#SavingAndReloading "Saving and Reloading the configuration")
    - [Configuration Profiles](#ConfigurationProfiles "Configuration Profiles")
      - [Basic Management](#ProfilesBasicManagement "Basic Management")
      - [Creating a Profile](#ProfilesCreating "Creating a Profile")
      - [Manual Activation](#ConfigProfileManual "Manual Activation")
      - [Triggers](#ConfigProfileTriggers "Triggers")
      - [Editing a Profile](#ConfigProfileEditing "Editing a Profile")
      - [Temporarily Disabling Triggers](#ConfigProfileDisablingTriggers "Temporarily Disabling Triggers")
      - [Activating a profile using input gestures](#ConfigProfileGestures "Activating a profile using input gestures")
    - [Location of Configuration files](#LocationOfConfigurationFiles "Location of Configuration files")
  - [Remote Access](#RemoteAccess "Remote Access")
    - [Getting Started](#RemoteAccessGettingStarted "Getting Started")
    - [Setting Up a Remote Access Session](#RemoteAccessSetup "Setting Up a Remote Access Session")
      - [Mode Selection (Controlling or Controlled)](#RemoteAccessMode "Mode Selection (Controlling or Controlled)")
      - [Connecting to an existing server (Host and Key Provided)](#RemoteAccessJoin "Connecting to an existing server (Host and Key Provided)")
      - [Starting a Connection Via a Relay Server](#RemoteAccessConnectRelay "Starting a Connection Via a Relay Server")
      - [Using NVDA as the server](#RemoteAccessConnectSelfHosted "Using NVDA as the server")
    - [Using Remote Access](#RemoteAccessUsage "Using Remote Access")
    - [Remote Access Key Commands Summary](#RemoteAccessGestures "Remote Access Key Commands Summary")
  - [Add-ons and the Add-on Store](#AddonsManager "Add-ons and the Add-on Store")
    - [Browsing add-ons](#AddonStoreBrowsing "Browsing add-ons")
      - [Add-on list views](#AddonStoreFilterStatus "Add-on list views")
      - [Filtering for enabled or disabled add-ons](#AddonStoreFilterEnabled "Filtering for enabled or disabled add-ons")
      - [Include incompatible add-ons](#AddonStoreFilterIncompatible "Include incompatible add-ons")
      - [Filter add-ons by channel](#AddonStoreFilterChannel "Filter add-ons by channel")
      - [Searching for add-ons](#AddonStoreFilterSearch "Searching for add-ons")
      - [Sorting the add-ons list by column](#AddonStoreSortByColumn "Sorting the add-ons list by column")
    - [Add-on actions](#AddonStoreActions "Add-on actions")
      - [Installing add-ons](#AddonStoreInstalling "Installing add-ons")
      - [Removing Add-ons](#AddonStoreRemoving "Removing Add-ons")
      - [Disabling and Enabling Add-ons](#AddonStoreDisablingEnabling "Disabling and Enabling Add-ons")
      - [Reviewing add-ons and reading reviews](#AddonStoreReviews "Reviewing add-ons and reading reviews")
      - [Changing the automatic update channel](#AddonStoreUpdateChannel "Changing the automatic update channel")
    - [Incompatible Add-ons](#incompatibleAddonsManager "Incompatible Add-ons")
  - [Extra Tools](#ExtraTools "Extra Tools")
    - [Log Viewer](#LogViewer "Log Viewer")
    - [Speech Viewer](#SpeechViewer "Speech Viewer")
    - [Braille Viewer](#BrailleViewer "Braille Viewer")
    - [Python Console](#PythonConsole "Python Console")
    - [Add-on Store](#AddonStoreMenuItem "Add-on Store")
    - [Create portable copy](#CreatePortableCopy "Create portable copy")
    - [Run COM registration fixing tool...](#RunCOMRegistrationFixingTool "Run COM registration fixing tool...")
    - [Reload plugins](#ReloadPlugins "Reload plugins")
  - [Supported Speech Synthesizers](#SupportedSpeechSynths "Supported Speech Synthesizers")
    - [eSpeak NG](#eSpeakNG "eSpeak NG")
    - [Microsoft Speech API version 4 (SAPI 4)](#SAPI4 "Microsoft Speech API version 4 (SAPI 4)")
    - [Microsoft Speech API version 5 (SAPI 5)](#SAPI5 "Microsoft Speech API version 5 (SAPI 5)")
    - [Microsoft Speech Platform](#MicrosoftSpeechPlatform "Microsoft Speech Platform")
    - [Windows OneCore Voices](#OneCore "Windows OneCore Voices")
  - [Supported Braille Displays](#SupportedBrailleDisplays "Supported Braille Displays")
    - [Displays supporting automatic detection in the background](#AutomaticDetection "Displays supporting automatic detection in the background")
    - [Freedom Scientific Focus/PAC Mate Series](#FreedomScientificFocus "Freedom Scientific Focus/PAC Mate Series")
    - [Optelec ALVA 6 series/protocol converter](#OptelecALVA "Optelec ALVA 6 series/protocol converter")
    - [Handy Tech Displays](#HandyTech "Handy Tech Displays")
    - [MDV Lilli](#MDVLilli "MDV Lilli")
    - [Baum/Humanware/APH/Orbit Braille Displays](#Baum "Baum/Humanware/APH/Orbit Braille Displays")
    - [hedo ProfiLine USB](#HedoProfiLine "hedo ProfiLine USB")
    - [hedo MobilLine USB](#HedoMobilLine "hedo MobilLine USB")
    - [HumanWare Brailliant BI/B Series / BrailleNote Touch](#HumanWareBrailliant "HumanWare Brailliant BI/B Series / BrailleNote Touch")
      - [Key assignments for All models](#HumanWareBrailliantKeyAssignmentForAllModels "Key assignments for All models")
      - [Key assignments for Brailliant BI 32, BI 40 and B 80](#HumanWareBrailliantKeyAssignmentForBI32BI40AndB80 "Key assignments for Brailliant BI 32, BI 40 and B 80")
      - [Key assignments for Brailliant BI 14](#HumanWareBrailliantKeyAssignmentForBI14 "Key assignments for Brailliant BI 14")
    - [HIMS Braille Sense/Braille EDGE/Smart Beetle/Sync Braille Series](#Hims "HIMS Braille Sense/Braille EDGE/Smart Beetle/Sync Braille Series")
    - [Seika Braille Displays](#Seika "Seika Braille Displays")
      - [Seika Version 3, 4, and 5 (40 cells), Seika80 (80 cells)](#SeikaBrailleDisplays "Seika Version 3, 4, and 5 (40 cells), Seika80 (80 cells)")
      - [MiniSeika (16, 24 cells), V6, and V6Pro (40 cells)](#SeikaNotetaker "MiniSeika (16, 24 cells), V6, and V6Pro (40 cells)")
    - [Papenmeier BRAILLEX Newer Models](#Papenmeier "Papenmeier BRAILLEX Newer Models")
    - [Papenmeier Braille BRAILLEX Older Models](#PapenmeierOld "Papenmeier Braille BRAILLEX Older Models")
    - [HumanWare BrailleNote](#HumanWareBrailleNote "HumanWare BrailleNote")
    - [EcoBraille](#EcoBraille "EcoBraille")
    - [SuperBraille](#SuperBraille "SuperBraille")
    - [Eurobraille displays](#Eurobraille "Eurobraille displays")
      - [Braille keyboard functions](#EurobrailleBraille "Braille keyboard functions")
      - [b.book keyboard commands](#Eurobraillebbook "b.book keyboard commands")
      - [b.note keyboard commands](#Eurobraillebnote "b.note keyboard commands")
      - [Esys keyboard commands](#Eurobrailleesys "Esys keyboard commands")
      - [Esytime keyboard commands](#EurobrailleEsytime "Esytime keyboard commands")
    - [Nattiq nBraille Displays](#NattiqTechnologies "Nattiq nBraille Displays")
    - [BRLTTY](#BRLTTY "BRLTTY")
    - [Tivomatic Caiku Albatross 46/80](#Albatross "Tivomatic Caiku Albatross 46/80")
    - [NLS eReader Zoomax](#Zoomax "NLS eReader Zoomax")
    - [Standard HID Braille displays](#HIDBraille "Standard HID Braille displays")
    - [Dot Pad](#dotPad "Dot Pad")
  - [Advanced Topics](#AdvancedTopics "Advanced Topics")
    - [Secure Mode](#SecureMode "Secure Mode")
    - [Secure Screens](#SecureScreens "Secure Screens")
    - [Command Line Options](#CommandLineOptions "Command Line Options")
    - [Uninstalling NVDA](#UninstallingNVDA "Uninstalling NVDA")
    - [System Wide Parameters](#SystemWideParameters "System Wide Parameters")
  - [Further Information](#FurtherInformation "Further Information")
...
NVDA is developed by [NV Access](https://www.nvaccess.org/ "NV Access"), with contributions from the community.
...
A short video demonstration, ["What is NVDA?"](https://www.youtube.com/watch?v=tCFyyqy9mqo "\"What is NVDA?\"") is available from the NV Access YouTube channel.
...
- Ability to [connect to and control another computer running NVDA](#RemoteAccess "connect to and control another computer running NVDA") for remote assistance or collaboration
...
- Ability to run during Windows sign-in and [other secure screens](#SecureScreens "other secure screens")
...
NVDA is bundled with [eSpeak NG](https://github.com/espeak-ng/espeak-ng "eSpeak NG"), a free, open-source, multi-lingual speech synthesizer.

Information about other speech synthesizers that NVDA supports can be found in the [Supported Speech Synthesizers](#SupportedSpeechSynths "Supported Speech Synthesizers") section.

### Braille support

For users that own a refreshable braille display, NVDA can output its information in braille.
NVDA uses the open source braille translator [LibLouis](https://liblouis.io/ "LibLouis") to generate braille sequences from text.
...
Please see the [Supported Braille Displays](#SupportedBrailleDisplays "Supported Braille Displays") section for information about the supported braille displays.

NVDA supports braille codes for many languages, including contracted, uncontracted and computer braille codes.

### License and Copyright

NVDA is copyright 2006-2025 NVDA contributors.
...
For further details, you can [view the full license.](https://www.gnu.org/licenses/old-licenses/gpl-2.0.html "view the full license.")
...
- [Downloading](#GettingAndSettingUpNVDA "Downloading"): Where to get NVDA and steps for downloading it
- [Initial setup](#SettingUpNVDA "Initial setup"): Steps to install and setup NVDA
- [Running NVDA](#RunningNVDA "Running NVDA"): Commonly used keystrokes and NVDA features

These are followed by information on [adjusting preferences](#Preferences "adjusting preferences"), [using add-ons](#Addons "using add-ons"), [participating in the community](#Community "participating in the community") and [getting help](#GettingHelp "getting help").
...
The latest version of NVDA is always available from the "Download" page of the [NV Access website](https://www.nvaccess.org "NV Access website").

NVDA works with all recent versions of Microsoft Windows.
Check the [System Requirements](#SystemRequirements "System Requirements") for full details.

#### Steps for Downloading NVDA
...
#### Steps for running the downloaded launcher

The setup file is named "nvda\_2022.1.exe" or similar.
...
2. The NVDA Launcher window appears with a button to open the license agreement.
   Press the `downArrow` to read the license agreement.
3. Press `tab` to move to the "I agree" checkbox, then press the `spacebar` to check it.
4. Press `tab` to move through the options, then press `enter` on the desired option.
...
Installing NVDA will allow for additional functionality such as automatic starting after sign-in, the ability to read the Windows sign-in and [secure screens](#SecureScreens "secure screens").
These cannot be done with portable and temporary copies.
For full details of the limitations when running a portable or temporary copy of NVDA, please see [Portable and temporary copy restrictions](#PortableAndTemporaryCopyRestrictions "Portable and temporary copy restrictions").

Installing also offers to create Start Menu and desktop shortcuts, and allow NVDA to be started with `control+alt+n`.

#### Steps for installing NVDA from the launcher

These steps walk through the most common setup options.
For more details on the options available, please see [Installation options](#InstallingNVDA "Installation options").

1. From the launcher, ensure the checkbox to agree to the license is checked.
2. `Tab` to, and activate the "Install NVDA on this computer" button.
3. Next, are options to use NVDA during Windows sign-in and to create a desktop shortcut.
...
5. A Windows "User Account Control (UAC)" dialog appears asking "Do you want to allow this app to make changes to your PC?".
6. Press `alt+y` to accept the UAC prompt.
7. A progress bar fills up as NVDA installs.
   During this process NVDA sounds an increasingly higher pitched beep.
   This process is often fast and may not be noticed.
8. A dialog box appears to confirm that the install of NVDA has been successful.
   The message advises to "Press OK to start the installed copy".
   Press `enter` to start the installed copy.
9. The "Welcome to NVDA" dialog appears, and NVDA reads a welcome message.
...
10. Press `tab` to move to "Use `capsLock` as an NVDA modifier key".
...
11. Use `tab` and `spaceBar` to adjust the other options on this screen.
    These set whether NVDA starts automatically.
12. Press `enter` to close the dialog box with NVDA now running.
...
"Basic Training for NVDA" is available from the [NV Access Shop](http://www.nvaccess.org/shop "NV Access Shop").
...
#### Toggle which information NVDA reads
...
It is also possible to set the first or last value of the current synth setting by assign custom gestures in [Input Gestures dialog](#InputGestures "Input Gestures dialog"), under the speech category.
...
The full list of Single Letter Navigation keys is in the [Browse Mode](#BrowseMode "Browse Mode") section of the user guide.
...
Please refer to [Installing Add-ons](#AddonStoreInstalling "Installing Add-ons") for ways to verify add-ons prior to installation.
...
The "[Add-ons and the Add-on Store](#AddonsManager "Add-ons and the Add-on Store")" section of the User Guide contains information about every feature of the Add-on Store.
...
2. Press `tab` once to move to a description of the currently selected add-on.
3. Use the [reading keys](#ReadingText "reading keys") or arrow keys to read the full description.
4. Press `tab` to the "Actions" button, which can be used to install the add-on, among other actions.
5. Press `tab` to "Other Details", which lists details such as the publisher, version and homepage.
6. To return to the list of add-ons, press `alt+a`, or `shift+tab` until reaching the list.
...
2. The actions menu opens with a list of actions; the first action is "Install".
3. To install the add-on, press `i` or `downArrow` to "Install" and press `enter`.
4. The focus returns to the add-on in the list and NVDA will read the details about the add-on.
5. The "Status" information reported by NVDA changes from "Available" to "Downloading".
6. Once the add-on has finished downloading, it will change to "Downloaded. Pending install".
7. Repeat with any other add-ons you would like to install at the same time.
8. Once finished, press `tab` until the focus is on the "Close" button, then press `enter`.
9. The downloaded add-ons will start the installation process once the Add-on Store is closed.
   During the installation process, add-ons may display dialogs that you will need to respond to.
10. When the add-ons have been installed, a dialog appears advising that changes were made, and you must restart NVDA for the add-on installation to complete.
11. Press `enter` to restart NVDA.
...
To learn more about and configure this behaviour, refer to ["Update Notifications"](#AutomaticAddonUpdates "\"Update Notifications\"").

### Community

NVDA has a vibrant user community.
NV Access, makers of NVDA, are active on [Mastodon](https://fosstodon.org/@NVAccess "Mastodon"), [Twitter/X](https://x.com/nvaccess "Twitter/X") and [Facebook](https://www.facebook.com/NVAccess "Facebook").
NV Access also have a regular [In-Process blog](https://www.nvaccess.org/category/in-process/ "In-Process blog").
There is a main [NV Access owned email list](https://groups.google.com/a/nvaccess.org/g/nvda-users "NV Access owned email list") and a page full of [other community groups](https://github.com/nvaccess/nvda/wiki/Connect "other community groups").

There is also an [NVDA Certified Expert](https://certification.nvaccess.org/ "NVDA Certified Expert") program.
This is an online exam you can complete to demonstrate your skills in NVDA.
[NVDA Certified Experts](https://certification.nvaccess.org/ "NVDA Certified Experts") can list their contact and relevant business details.
...
There is also more comprehensive Training Material available in the [NV Access Shop](https://www.nvaccess.org/shop "NV Access Shop").
...
- [Electronic text](https://www.nvaccess.org/product/basic-training-for-nvda-ebook/ "Electronic text"), which includes Word DOCX, Web page HTML, eBook ePub and Kindle KFX formats.
- [Human-read, MP3 audio](https://www.nvaccess.org/product/basic-training-for-nvda-downloadable-audio/ "Human-read, MP3 audio")
- [Hard-copy UEB Braille](https://www.nvaccess.org/product/basic-training-for-nvda-braille-hard-copy/ "Hard-copy UEB Braille") with delivery included anywhere in the world.

Other modules, and the discounted [NVDA Productivity Bundle](https://www.nvaccess.org/product/nvda-productivity-bundle/ "NVDA Productivity Bundle"), are available in the [NV Access Shop](https://www.nvaccess.org/shop/ "NV Access Shop").

NV Access also sells [telephone support](https://www.nvaccess.org/product/nvda-telephone-support/ "telephone support"), either in blocks, or as part of the [NVDA Productivity Bundle](https://www.nvaccess.org/product/nvda-productivity-bundle/ "NVDA Productivity Bundle").
Telephone support includes local numbers in Australia and the USA.

The [email user groups](https://github.com/nvaccess/nvda/wiki/Connect "email user groups") are a great source of community help, as are [certified NVDA experts](https://certification.nvaccess.org/ "certified NVDA experts").

You can make bug reports or feature requests via [GitHub](https://github.com/nvaccess/nvda/blob/master/projectDocs/issues/readme.md "GitHub").
The [contribution guidelines](https://github.com/nvaccess/nvda/blob/master/.github/CONTRIBUTING.md "contribution guidelines") contain valuable information for contributing to the community.
...
Refer to the [incompatible add-ons dialog section](#incompatibleAddonsManager "incompatible add-ons dialog section") for more help on this button.
After installation, you are able to re-enable incompatible add-ons at your own risk from within the [Add-on Store](#AddonsManager "Add-on Store").
...
This also includes User Account Control and [other secure screens](#SecureScreens "other secure screens").
...
This will not copy the configuration for any other users of this system nor to the system configuration for use during Windows sign-in and [other secure screens](#SecureScreens "other secure screens").
...
The [NVDA installer](#StepsForRunningTheDownloadLauncher "NVDA installer") can be used as a temporary copy of NVDA.
Temporary copies prevent saving NVDA settings.
This includes disabling usage of the [Add-on Store](#AddonsManager "Add-on Store").
...
You can also pass some [command line options](#CommandLineOptions "command line options") which allows you to quit (-q), disable add-ons (--disable-addons), etc.
...
Consult the section about [system wide parameters](#SystemWideParameters "system wide parameters") for more details.
...
You can read more info about the data gathered by NV Access in the general settings section, [Allow NV Access to gather NVDA usage statistics](#GeneralSettingsGatherUsageStats "Allow NV Access to gather NVDA usage statistics").
Note: pressing on "yes" or "no" will save this setting and the dialog will never appear again unless you reinstall NVDA.
However, you can enable or disable the data gathering process manually in NVDA's general settings panel. For changing this setting manually, you can check or uncheck the checkbox called [Allow the NVDA project to gather NVDA usage statistics](#GeneralSettingsGatherUsageStats "Allow the NVDA project to gather NVDA usage statistics").
...
There are several NVDA add-ons available in the NVDA Add-on Store that provide support for math, including the [MathCAT NVDA add-on](https://nsoiffer.github.io/MathCAT/ "MathCAT NVDA add-on") and [Access8Math](https://github.com/tsengwoody/Access8Math "Access8Math").
Please refer to the [Add-on Store section](#AddonsManager "Add-on Store section") to learn how to browse and install available add-ons in NVDA.
NVDA also can make use of the older [MathPlayer](https://info.wiris.com/mathplayer-info "MathPlayer") software from Wiris if found on your system, though this software is no longer maintained.
...
- Microsoft Word 365 Modern Math Equations via UI automation:
  ...
  For further details, please see [Linear format equations using UnicodeMath and LaTeX in Word](https://support.microsoft.com/en-us/office/linear-format-equations-using-unicodemath-and-latex-in-word-2e00618d-b1fd-49d8-8cb4-8d17f25754f8 "Linear format equations using UnicodeMath and LaTeX in Word")
- Microsoft Powerpoint, and older versions of Microsoft Word:
  ...
  It can be downloaded from the [MathType presentation page](https://www.wiris.com/en/mathtype/ "MathType presentation page").
- Adobe Reader:
...
- [MathCAT documentation](https://nsoiffer.github.io/MathCAT/users.html "MathCAT documentation")
- [Access8Math documentation](https://github.com/tsengwoody/Access8Math "Access8Math documentation")
- [MathPlayer documentation](https://docs.wiris.com/mathplayer/en/mathplayer-user-manual.html "MathPlayer documentation")
...
[Download MathPlayer](https://downloads.wiris.com/mathplayer/MathPlayerSetup.exe "Download MathPlayer").
...
Braille can also be displayed on screen using the [Braille Viewer](#BrailleViewer "Braille Viewer") instead of, or at the same time as, using a physical braille display.
...
You can configure braille using the [Braille category](#BrailleSettings "Braille category") of the [NVDA Settings](#NVDASettings "NVDA Settings") dialog.
...
You can select the translation table used to translate braille into text using the [Input table](#BrailleSettingsInputTable "Input table") setting in the Braille category of the [NVDA Settings](#NVDASettings "NVDA Settings") dialog.
...
You can change these assignments or add new emulated keys from the [Input Gestures dialog](#InputGestures "Input Gestures dialog").
...
Additional vision enhancement providers can be provided in [NVDA add-ons](#AddonsManager "NVDA add-ons").

NVDA's vision settings can be changed in the [vision category](#VisionSettings "vision category") of the [NVDA Settings](#NVDASettings "NVDA Settings") dialog.

### Visual Highlight

Visual Highlight can help to identify the [system focus](#SystemFocus "system focus"), [navigator object](#ObjectNavigation "navigator object") and [browse mode](#BrowseMode "browse mode") positions.
These positions are highlighted with a coloured rectangle outline.

- Solid blue highlights a combined navigator object and system focus location (e.g. because [the navigator object follows the system focus](#ReviewCursorFollowFocus "the navigator object follows the system focus")).
...
When Visual Highlight is enabled in the [vision category](#VisionSettings "vision category") of the [NVDA Settings](#NVDASettings "NVDA Settings") dialog, you can [change whether or not to highlight the focus, navigator object or browse mode caret](#VisionSettingsFocusHighlight "change whether or not to highlight the focus, navigator object or browse mode caret").
...
You can enable the Screen Curtain in the [vision category](#VisionSettings "vision category") of the [NVDA Settings](#NVDASettings "NVDA Settings") dialog.
...
When the Screen Curtain is active some tasks directly based on what appears on the screen such as performing [OCR](#Win10Ocr "OCR") or taking a screenshot cannot be achieved.
...
When you use a content recognition command, NVDA recognizes content from the current [navigator object](#ObjectNavigation "navigator object").
...
You can set the language to use for text recognition in the [Windows OCR category](#Win10OcrSettings "Windows OCR category") of the [NVDA Settings](#NVDASettings "NVDA Settings") dialog.
...
This can also be done in the [Windows OCR category](#Win10OcrSettings "Windows OCR category") of the [NVDA Settings](#NVDASettings "NVDA Settings") dialog.

Windows OCR may be partially or fully incompatible with [NVDA vision enhancements](#Vision "NVDA vision enhancements") or other external visual aids. You will need to disable these aids before proceeding to a recognition.
...
This requires that the Report Table row / column headers option in NVDA's Document Formatting settings, found in the [NVDA Settings](#NVDASettings "NVDA Settings") dialog, be turned on.

If you use [UIA to access Word documents](#MSWordUIA "UIA to access Word documents"), which is default in recent versions of Word and Windows, the cells of the first row will automatically be considered as column headers; similarly, the cells of the first column will automatically be considered as row headers.

On the contrary, if you do not use [UIA to access Word documents](#MSWordUIA "UIA to access Word documents"), you will have to indicate to NVDA which row or column contains the headers in any given table.
...
For further information about Browse mode and Quick Navigation, see the [Browse Mode section](#BrowseMode "Browse Mode section").
...
This firstly requires that the Report Table row / column headers option in NVDA's Document Formatting settings, found in the [NVDA Settings](#NVDASettings "NVDA Settings") dialog, be turned on.
...
For further information about Browse mode and single letter navigation, see the [Browse Mode section](#BrowseMode "Browse Mode section").
...
Please see the [Reading Mathematical Content](#ReadingMath "Reading Mathematical Content") section for further information.
...
The following built-in Windows Console keyboard shortcuts may be useful when [reviewing text](#ReviewingText "reviewing text") with NVDA in older versions of Windows Console:
...
Many of these settings can be found in the multi-page [NVDA Settings dialog](#NVDASettings "NVDA Settings dialog").
...
If you frequently access categories that do not have dedicated shortcut keys, you may wish to use the [Input Gestures dialog](#InputGestures "Input Gestures dialog") to add a custom gesture such as a keyboard command or touch gesture for that category.
...
##### Use NVDA during sign-in (requires administrator privileges)
...
Pressing this button copies your currently saved NVDA user configuration to NVDA's system configuration directory, so that NVDA will use it during sign-in and when running on User Account Control (UAC) and other [secure screens](#SecureScreens "secure screens").
...
If you wish to change the update mirror, press the "Change..." button to open the [Set Update Mirror dialog](#SetURLDialog "Set Update Mirror dialog").

Please note that when using an update mirror, the operator of the mirror has access to all [information sent with update checks](#GeneralSettingsCheckForUpdates "information sent with update checks").
...
For a quicker alternative way of controlling speech parameters from anywhere, please see the [Synth Settings Ring](#SynthSettingsRing "Synth Settings Ring") section.
...
This button activates the [Select Synthesizer](#SelectSynthesizer "Select Synthesizer") dialog, which allows you to select the active speech synthesizer.
...
Note that in Advanced settings, there is a similar [option for SAPI 4 voices](#UseWASAPIForSAPI4 "option for SAPI 4 voices"), not to be confused with this one.
...
##### Report language changes while reading
...
##### Report when switching to language is not supported by synthesizer
...
If [Automatic Language switching](#SpeechSettingsLanguageSwitching "Automatic Language switching") is disabled, this option won't take effect, and the combo box will be readonly.
...
2. Normalization to composed characters.
   ...
   2. A decomposition into two characters (ü), namely the normal latin letter u and a diaeresis modifier
...
3. Decomposition of some ligatures, Including "ĳ" (ligature ij) to their two letter form ("ij").
4. Stable ordering of modifiers in composite characters, for example in ancient Hebrew.

To toggle Unicode normalization from anywhere, please assign a custom gesture using the [Input Gestures dialog](#InputGestures "Input Gestures dialog").
...
##### Report "Normalized" when navigating by character
...
Note that this setting is only available when "[Unicode normalization](#SpeechUnicodeNormalization "Unicode normalization")" is enabled.
...
These dictionaries contain descriptions for symbols (particularly emoji) that are provided by the [Unicode Consortium](https://www.unicode.org/consortium/ "Unicode Consortium") as part of their [Common Locale Data Repository](http://cldr.unicode.org/ "Common Locale Data Repository").
...
You can add, edit or remove symbol descriptions in NVDA's [punctuation/symbol pronunciation dialog](#SymbolPronunciation "punctuation/symbol pronunciation dialog").

To toggle Unicode Consortium data inclusion from anywhere, please assign a custom gesture using the [Input Gestures dialog](#InputGestures "Input Gestures dialog").
...
In case pitch change for capitals is not supported, consider [Say "cap" before capitals](#SpeechSettingsSayCapBefore "Say \"cap\" before capitals") and/or  [Beep for capitals](#SpeechSettingsBeepForCaps " Beep for capitals") instead.
...
This checkable list allows selecting which [speech modes](#SpeechModes "speech modes") are included when cycling between them using `NVDA+s`.
...
For a list of the Synthesizers that NVDA supports, please see the [Supported Speech Synthesizers](#SupportedSpeechSynths "Supported Speech Synthesizers") section.
...
The Change... button in the Braille category of the NVDA Settings dialog activates the [Select Braille Display](#SelectBrailleDisplay "Select Braille Display") dialog, which allows you to select the active braille display.
This dialog opens on top of the NVDA Settings dialog.
...
If input is not supported on a display which does have a braille keyboard, this will be noted in the [Supported Braille Displays](#SupportedBrailleDisplays "Supported Braille Displays") section.
...
To toggle show messages from anywhere, please assign a custom gesture using the [Input Gestures dialog](#InputGestures "Input Gestures dialog").
...
##### Move system caret when routing review cursor
...
When this option is set to Always, and [braille tethering](#BrailleTether "braille tethering") is set to "automatically" or "to review", pressing a cursor routing key will also move the system caret or focus when supported.
When the current review mode is [Screen Review](#ScreenReview "Screen Review"), there is no physical caret.
In this case, NVDA tries to focus the object under the text you're routing to.
The same applies to [object review](#ObjectReview "object review").
...
This option is shown only if "[tether braille](#BrailleTether "tether braille")" is set to "automatically" or "to review".

To toggle move system caret when routing review cursor from anywhere, please assign a custom gesture using the [Input Gestures dialog](#InputGestures "Input Gestures dialog").
...
Please consult the section about [object navigation](#ObjectNavigation "object navigation") for more information about the hierarchy that applies to objects in NVDA.
...
To toggle focus context presentation from anywhere, please assign a custom gesture using the [Input Gestures dialog](#InputGestures "Input Gestures dialog").
...
To toggle show selection from anywhere, please assign a custom gesture using the [Input Gestures dialog](#InputGestures "Input Gestures dialog").
...
This option only has an effect if NVDA is set to [display font attributes in braille](#DocumentFormattingFontAttributes "display font attributes in braille").
...
| [Tags](#BrailleFormattingDisplayTags "Tags") | Use tags that describe how and where text formatting changes. |
...
##### Speak character when routing cursor in text
...
To toggle this option from anywhere, please assign a custom gesture using the [Input Gestures dialog](#InputGestures "Input Gestures dialog").
...
To toggle this option from anywhere, please assign a custom gesture to "speakOnNavigatingByUnit" in the "Braille" section of the [Input Gestures dialog](#InputGestures "Input Gestures dialog").
...
Other benefits of unicode normalization are explained in greater detail in the [section for the equivalent speech setting](#SpeechUnicodeNormalization "section for the equivalent speech setting").
...
Please see the [Supported Braille Displays](#SupportedBrailleDisplays "Supported Braille Displays") section for more information about supported braille displays and which of these support automatic detection in the background.

##### Displays to detect automatically
...
You may consult the documentation for your braille display in the section [Supported Braille Displays](#SupportedBrailleDisplays "Supported Braille Displays") to check whether the driver supports automatic detection of displays.
...
You may consult the documentation for your braille display in the section [Supported Braille Displays](#SupportedBrailleDisplays "Supported Braille Displays") to check for more details on the supported types of communication and available ports.
...
##### Time to keep audio device awake after speech
...
The Vision category in the NVDA Settings dialog allows you to enable, disable and configure [visual aids](#Vision "visual aids").

Note that the available options in this category could be extended by [NVDA add-ons](#AddonsManager "NVDA add-ons").
By default, this settings category contains the following options:

##### Visual Highlight

The check boxes in the Visual Highlight grouping control the behaviour of NVDA's built-in [Visual Highlight](#VisionFocusHighlight "Visual Highlight") facility.

- Enable Highlighting: Toggles Visual Highlight on and off.
- Highlight system focus: toggles whether the [system focus](#SystemFocus "system focus") will be highlighted.
- Highlight navigator object: toggles whether the [navigator object](#ObjectNavigation "navigator object") will be highlighted.
- Highlight browse mode cursor: Toggles whether the [virtual browse mode cursor](#BrowseMode "virtual browse mode cursor") will be highlighted.
...
You can enable the [Screen Curtain](#VisionScreenCurtain "Screen Curtain") by checking the "Make screen black (immediate effect)" check box.
...
##### Settings for third party visual aids
...
The checkboxes in this list control what keys can be used as [NVDA modifier keys](#TheNVDAModifierKey "NVDA modifier keys"). The following keys are available to choose from:
...
This option is only available if reporting of spelling errors is enabled in NVDA's [Document Formatting Settings](#DocumentFormattingSettings "Document Formatting Settings"), found in the NVDA Settings dialog.
...
To toggle text unit resolution from anywhere, please assign a custom gesture using the [Input Gestures dialog](#InputGestures "Input Gestures dialog").

##### Report object when mouse enters it
...
Note that the announcement of some object details might be dependent on how other settings are set, such as in the [object presentation](#ObjectPresentationSettings "object presentation") or [Document Formatting](#DocumentFormattingSettings "Document Formatting") categories.
...
To toggle simple review mode from anywhere, please assign a custom gesture using the [Input Gestures dialog](#InputGestures "Input Gestures dialog").
...
See the [Browse Mode section](#BrowseMode "Browse Mode section") for a list of applications supported by browse mode.
...
When on, NVDA will treat these as normal tables, reporting them based on [Document Formatting Settings](#DocumentFormattingSettings "Document Formatting Settings") and locating them with quick navigation commands.
...
To toggle inclusion of layout tables from anywhere, please assign a custom gesture using the [Input Gestures dialog](#InputGestures "Input Gestures dialog").

##### Configuring reporting of fields such as links and headings

Please see the options in the [Document Formatting category](#DocumentFormattingSettings "Document Formatting category") of the [NVDA Settings](#NVDASettings "NVDA Settings") dialog to configure the fields that are reported when navigating, such as links, headings and tables.
...
- Font
  - Font name
  - Font size
  - Font attributes [(Off, Speech, Braille, Speech and braille)](#DocumentFormattingFontAttributes "(Off, Speech, Braille, Speech and braille)")
...
- Pages and spacing
  - Page numbers
  - Line numbers
  - Line indentation reporting [(Off, Speech, Tones, Both Speech and Tones)](#DocumentFormattingSettingsLineIndentation "(Off, Speech, Tones, Both Speech and Tones)")
...
To toggle these settings from anywhere, please assign custom gestures using the [Input Gestures dialog](#InputGestures "Input Gestures dialog").
...
- Braille: NVDA will display these attributes in braille.
  Exactly how they are displayed can be configured in [NVDA's braille settings](#BrailleFormattingDisplay "NVDA's braille settings").
...
You may toggle through the available paragraph styles from anywhere by assigning a key in the [Input Gestures dialog](#InputGestures "Input Gestures dialog").
...
By default, notifications will only occur for add-ons with updates available within the same [channel](#AddonStoreFilterChannel "channel") (e.g. stable, beta or dev).
You can configure add-on update channels [individually for each add-on](#AddonStoreUpdateChannel "individually for each add-on") or for [all add-ons](#DefaultAddonUpdateChannel "all add-ons").
...
When [Automatic add-on updates](#AutomaticAddonUpdates "Automatic add-on updates") are enabled, by default, add-ons only update to the same [channel](#AddonStoreFilterChannel "channel").
...
You can also change the update channel for a [specific add-on individually from the Add-on Store](#AddonStoreUpdateChannel "specific add-on individually from the Add-on Store").
...
If you wish to change the Add-on Store mirror, press the "Change..." button to open the [Set Add-on Store Mirror dialog](#SetURLDialog "Set Add-on Store Mirror dialog").

#### Remote Access Settings

This category allows you to configure the behaviour of [Remote Access](#RemoteAccess "Remote Access").
...
Please note that in order to continue a Remote Access session on secure screens such as User Account Control prompts, you must enable this setting, save the changes, and then [copy your settings to NVDA's system configuration directory](#GeneralSettingsCopySettings "copy your settings to NVDA's system configuration directory").
...
##### Confirm before disconnecting when controlled
...
##### Mute when controlling the local computer
...
You can still manually mute or unmute Remote Access when controlling the local computer [via the Remote Access menu](#RemoteAccessUsage "via the Remote Access menu"), or by assigning a custom gesture using the [Input Gestures dialog](#InputGestures "Input Gestures dialog").
...
For further details on the following options, please refer to the [Setting Up a Remote Access Session section](#RemoteAccessSetup "Setting Up a Remote Access Session section")

##### Mode

Select the connection mode for automatic connections.

This option is only available when [Automatically connect after NVDA starts](#RemoteAutoconnect "Automatically connect after NVDA starts") is checked.
...
This option is only available when [Automatically connect after NVDA starts](#RemoteAutoconnect "Automatically connect after NVDA starts") is checked, and [Server](#RemoteAutoconnectServer "Server") is set to "Use existing".

##### Port

Use this field to set the TCP port you would like to use for automatic connections.

This option is only available when [Automatically connect after NVDA starts](#RemoteAutoconnect "Automatically connect after NVDA starts") is checked, and [Server](#RemoteAutoconnectServer "Server") is set to "Host locally".
...
The settings in this category allow you to configure [Windows OCR](#Win10Ocr "Windows OCR").
This category contains the following options:

##### Recognition language

This combo box allows you to choose the language to be used for text recognition.
To cycle through available languages from anywhere, please assign a custom gesture using the [Input Gestures dialog](#InputGestures "Input Gestures dialog").

##### Periodically refresh recognized content
...
This dialog allows you to specify the URL of a mirror to use when [updating NVDA](#GeneralSettingsCheckForUpdates "updating NVDA") or [using the Add-on Store](#AddonsManager "using the Add-on Store").
This may be of use in locations where access to the NV Access servers for these functions is slow or unavailable.

- When setting the [NVDA update mirror](#UpdateMirror "NVDA update mirror"), the title of this dialog will be "Set NVDA Update Mirror".
- When setting the [Add-on Store mirror](#AddonStoreMetadataMirror "Add-on Store mirror"), the title of this dialog will be "Set Add-on Store Mirror Server".
...
As their equivalents in add-ons, these modules are loaded when starting NVDA or, in the case of appModules and globalPlugins, when [reloading plugins](#ReloadPlugins "reloading plugins").
...
##### Use UI automation to access Microsoft Excel spreadsheet controls when available
...
In Windows 10 version 1709, Microsoft [added support for its UI Automation API to the console](https://devblogs.microsoft.com/commandline/whats-new-in-windows-console-in-windows-10-fall-creators-update/ "added support for its UI Automation API to the console"), bringing vastly improved performance and stability for screen readers that support it.
...
##### Use UIA with Microsoft Edge and other Chromium based browsers when available
...
##### Speak passwords in all enhanced terminals

This setting controls whether characters are spoken by [speak typed characters](#KeyboardSettingsSpeakTypedCharacters "speak typed characters") or [speak typed words](#KeyboardSettingsSpeakTypedWords "speak typed words") in situations where the screen does not update (such as password entry) in some terminal programs, such as the Windows Console with UI automation support enabled and Mintty.
...
In untrusted environments, you may temporarily disable [speak typed characters](#KeyboardSettingsSpeakTypedCharacters "speak typed characters") and [speak typed words](#KeyboardSettingsSpeakTypedWords "speak typed words") when entering passwords.
...
Note that in Speech settings, there is a similar [option for SAPI 5 voices](#SpeechSettingsUseWasapi "option for SAPI 5 voices"), not to be confused with this one.
...
##### Report transparency for colors
...
The [text paragraph navigation command](#TextNavigationCommand "text paragraph navigation command") searches for paragraphs matched by this regular expression.

### miscellaneous Settings

Besides the [NVDA Settings](#NVDASettings "NVDA Settings") dialog, The Preferences sub-menu of the NVDA Menu contains several other items which are outlined below.
...
You need to assign custom gestures using the [Input Gestures dialog](#InputGestures "Input Gestures dialog") if you wish to open any of these dictionary dialogs from anywhere.
...
For an introductory tutorial, please refer to [Python's Regular Expression Guide](https://docs.python.org/3.11/howto/regex.html "Python's Regular Expression Guide").
...
Note that this dialog respects the "Trust voice's language for processing symbols and characters" option found in the [Speech category](#SpeechSettings "Speech category") of the [NVDA Settings](#NVDASettings "NVDA Settings") dialog; i.e. it uses the voice language rather than the NVDA global language setting when this option is enabled.
...
Most settings can be changed in configuration profiles except for those in the General category of the [NVDA Settings](#NVDASettings "NVDA Settings") dialog, which apply to the entirety of NVDA.
...
See [below](#ConfigProfileTriggers "below") for more information about triggers.
...
To edit the profile associated with say all, you must [manually activate](#ConfigProfileManual "manually activate") that profile.
...
To toggle disabling triggers from anywhere, please assign a custom gesture using the [Input Gestures dialog](#InputGestures "Input Gestures dialog").

#### Activating a profile using input gestures
...
You can add gestures to activate a profile using the [Input Gestures dialog](#InputGestures "Input Gestures dialog").
...
To open your settings directory from anywhere you can use [Input Gestures dialog](#InputGestures "Input Gestures dialog") to add a custom gesture.
...
To change NVDA's configuration during sign-in or on UAC screens, configure NVDA as you wish while signed into Windows, save the configuration, and then press the "use currently saved settings during sign-in and on secure screens" button in the General category of the [NVDA Settings](#NVDASettings "NVDA Settings") dialog.
...
You can enable Remote Access [in Remote Access settings](#RemoteSettings "in Remote Access settings").

### Getting Started

Before you begin, ensure NVDA is installed and running on both computers.
Also ensure that the Enable Remote Access checkbox [in Remote Access settings](#RemoteSettings "in Remote Access settings") is checked on both computers.
...
If NVDA is running in [secure mode](#SecureMode "secure mode"), you cannot manually initiate a new Remote Access session.
However, NVDA will still automatically start a new Remote Access session if configured to do so with the [Automatically connect after NVDA starts](#RemoteAutoconnect "Automatically connect after NVDA starts") setting.
You can still manually disconnect in secure mode.

### Setting Up a Remote Access Session
...
2. In the Host field, Enter the host address (and port if also given).
...
3. In the Key field, enter the key provided.
...
1. For Server, choose "Use existing".
2. For host, provide the host name of a relay server, such as `nvdaremote.com`.
   ...
   - You may include the port to connect on by appending a colon (":") and the port number to the host.
     For example, `example.com:1234`.
3. For key: come up with a long, hard to guess key, or press the "Generate Key" button to have one automatically generated.
...
4. Press OK.
5. Provide the connection details (such as host and key) to the other person so they can connect.
...
2. If connecting over the internet, you can press the "Get External IP" button to show your external IP (internet visible) address.
   You will need to provide this external IP to the other person.
3. If connecting over a local network, you will need to provide the other person with your local IP.
   Locating this is not covered in this documentation.
4. For Port, enter the port you want to use for incoming Remote connections.
...
5. For key: come up with a long, hard to guess key, or press the "Generate Key" button to have one automatically generated.
   You will need to provide this to the other person.
   - Note that the key acts as both the identifier for the session and the password, so it is very important it is hard to guess.
6. Press OK.
7. Provide the connection details (such as host and key) to the other person so they can connect.
...
| Connect | None | Starts a new Remote Access session. Unavailable in [secure mode](#SecureMode "secure mode"). |
...
To access the Add-on Store from anywhere, assign a custom gesture using the [Input Gestures dialog](#InputGestures "Input Gestures dialog").
...
Add-ons have associated actions that you can access through an [actions menu](#AddonStoreActions "actions menu"), such as install, help, disable, and remove.
...
Available and updatable add-ons can be filtered to include [incompatible add-ons](#incompatibleAddonsManager "incompatible add-ons") that are available to install.
...
You can install and update add-ons by [browsing Available add-ons](#AddonStoreBrowsing "browsing Available add-ons").
...
You can manage the automatic update channels for add-ons from the [installed and updatable add-ons tabs](#AddonStoreFilterStatus "installed and updatable add-ons tabs").
When [Automatic add-on updates](#AutomaticAddonUpdates "Automatic add-on updates") are enabled, add-ons will update to the same [channel](#AddonStoreFilterChannel "channel") they were installed from by [default](#DefaultAddonUpdateChannel "default").
...
| Option | Behaviour |
| --- | --- |
| Default | Add-on will follow the [default update channel](#DefaultAddonUpdateChannel "default update channel") |
...
Alternatively, use the [command line option](#CommandLineOptions "command line option") `--disable-addons`.

You can browse available incompatible add-ons using the [available and updatable add-ons tabs](#AddonStoreFilterStatus "available and updatable add-ons tabs").
You can browse installed incompatible add-ons using the [incompatible add-ons tab](#AddonStoreFilterStatus "incompatible add-ons tab").
...
To toggle the speech viewer from anywhere, please assign a custom gesture using the [Input Gestures dialog](#InputGestures "Input Gestures dialog").
...
Physical braille displays typically have buttons to scroll forwards or backwards, to enable scrolling with the braille viewer tool use the [Input Gestures dialog](#InputGestures "Input Gestures dialog") to assign keyboard shortcuts which "Scrolls the braille display back" and "Scrolls the braille display forward"
...
To toggle the braille viewer from anywhere, please assign a custom gesture using the [Input Gestures dialog](#InputGestures "Input Gestures dialog").
...
For more information, please see the [NVDA Developer Guide](https://download.nvaccess.org/documentation/developerGuide.html "NVDA Developer Guide").

### Add-on Store

This will open the [NVDA Add-on Store](#AddonsManager "NVDA Add-on Store").
For more information, read the in-depth section: [Add-ons and the Add-on Store](#AddonsManager "Add-ons and the Add-on Store").
...
Follow the directions in [Creating a portable copy](#CreatingAPortableCopy "Creating a portable copy") for more information.
...
For an even more extensive list of free and commercial synthesizers that you can purchase and download for use with NVDA, please see the [extra voices page](https://github.com/nvaccess/nvda/wiki/ExtraVoices "extra voices page").

### eSpeak NG

The [eSpeak NG](https://github.com/espeak-ng/espeak-ng "eSpeak NG") synthesizer is built directly into NVDA and does not require any other special drivers or components to be installed.
On Windows 8.1 NVDA uses eSpeak NG by default ([Windows OneCore](#OneCore "Windows OneCore") is used in Windows 10 and later by default).
...
When using this synthesizer with NVDA, the available voices (accessed from the [Speech category](#SpeechSettings "Speech category") of the [NVDA Settings](#NVDASettings "NVDA Settings") dialog or by the [Synth Settings Ring](#SynthSettingsRing "Synth Settings Ring")) will contain all the voices from all the installed SAPI 4 engines found on your system.
...
When using this synthesizer with NVDA, the available voices (accessed from the [Speech category](#SpeechSettings "Speech category") of the [NVDA Settings](#NVDASettings "NVDA Settings") dialog or by the [Synth Settings Ring](#SynthSettingsRing "Synth Settings Ring")) will contain all the voices from all the installed SAPI 5 engines found on your system.
...
- [Microsoft Speech Platform - Runtime (Version 11), x86](https://www.microsoft.com/download/en/details.aspx?id=27225 "Microsoft Speech Platform - Runtime (Version 11), x86")
- [Microsoft Speech Platform - Runtime Languages (Version 11)](https://www.microsoft.com/download/en/details.aspx?id=27224 "Microsoft Speech Platform - Runtime Languages (Version 11)")
  - This page includes many files for both speech recognition and text-to-speech.
    ...
    For example, the file MSSpeech\_TTS\_en-US\_ZiraPro.msi is a U.S. English voice.
...
On Windows 10 and later, NVDA uses Windows OneCore voices by default ([eSpeak NG](#eSpeakNG "eSpeak NG") is used in other releases).
...
Please see [Supported languages and voices](https://support.microsoft.com/en-us/windows/appendix-a-supported-languages-and-voices-4486e345-7730-53da-fcfe-55cc64300f01 "Supported languages and voices") for a list of available voices.

## Supported Braille Displays

This section contains information about the Braille displays supported by NVDA.

### Displays supporting automatic detection in the background

NVDA has the ability to detect many braille displays in the background automatically, either via USB or bluetooth.
This behaviour is achieved by selecting the Automatic option as the preferred braille display from NVDA's [Braille Settings dialog](#BrailleSettings "Braille Settings dialog").
...
All Focus and PAC Mate displays from [Freedom Scientific](https://www.freedomscientific.com/ "Freedom Scientific") are supported when connected via USB or bluetooth.
You will need the Freedom Scientific braille display drivers installed on your system.
If you do not have them already, you can obtain them from the [Focus Blue Braille Display Driver page](https://support.freedomscientific.com/Downloads/Focus/FocusBlueBrailleDisplayDriver "Focus Blue Braille Display Driver page").
...
Both the ALVA BC640 and BC680 displays from [Optelec](https://www.optelec.com/ "Optelec") are supported when connected via USB or bluetooth.
...
NVDA supports most displays from [Handy Tech](https://www.handytech.de/ "Handy Tech") when connected via USB, serial port or bluetooth.
For older USB displays, you will need to install the USB drivers from Handy Tech on your system.

The following displays are not supported out of the box, but can be used via [Handy Tech's universal driver](https://handytech.de/en/service/downloads-and-manuals/handy-tech-software/braille-display-drivers "Handy Tech's universal driver") and NVDA add-on:
...
The Lilli braille display available from [MDV](https://www.mdvbologna.it/ "MDV") is supported.
...
Several [Baum](https://www.visiobraille.de/index.php?article_id=1&clang=2 "Baum"), [HumanWare](https://www.humanware.com/ "HumanWare"), [APH](https://www.aph.org/ "APH") and [Orbit](https://www.orbitresearch.com/ "Orbit") displays are supported when connected via USB, bluetooth or serial.
These include:
...
The hedo ProfiLine USB from [hedo Reha-Technik](https://www.hedo.de/ "hedo Reha-Technik") is supported.
...
The hedo MobilLine USB from [hedo Reha-Technik](https://www.hedo.de/ "hedo Reha-Technik") is supported.
You must first install the USB drivers provided by the manufacturer.
...
The Brailliant BI and B series of displays from [HumanWare](https://www.humanware.com/ "HumanWare"), including the BI 14, BI 32, BI 20X, BI 40, BI 40X and B 80, are supported when connected via USB or bluetooth.
...
NVDA supports Braille Sense, Braille EDGE, Smart Beetle and Sync Braille displays from [Hims](https://www.hims-inc.com/ "Hims") when connected via USB or bluetooth.
If connecting via USB, you will need to install the [USB drivers from HIMS](http://www.himsintl.com/upload/HIMS_USB_Driver_v25.zip "USB drivers from HIMS") on your system.
...
You can find more information about the displays on their [Demo and Driver Download page](https://en.seika-braille.com/down/index.html "Demo and Driver Download page").
...
- A device drivers must be installed before using Seika v3/4/5/80.
  The drivers are [provided by the manufacturer](https://en.seika-braille.com/down/index.html "provided by the manufacturer").
...
1. Please make sure that you have installed the [latest driver](https://www.papenmeier-rehatechnik.de/en/service/downloadcenter/software/articles/software-braille-devices.html "latest driver").
...
5. Open the properties and switch to the "Advanced" tab.
...
You should select the port to which the display is connected after you have chosen this driver in the [Select Braille Display](#SelectBrailleDisplay "Select Braille Display") dialog.
...
NVDA supports the BrailleNote notetakers from [Humanware](https://www.humanware.com "Humanware") when acting as a display terminal for a screen reader.
...
For BrailleNote Touch, please refer to the [Brailliant BI Series / BrailleNote Touch](#HumanWareBrailliant "Brailliant BI Series / BrailleNote Touch") section.
...
In NVDA, you may also need to set the port in the [Select Braille Display](#SelectBrailleDisplay "Select Braille Display") dialog.
...
NVDA supports EcoBraille displays from [ONCE](https://www.once.es/ "ONCE").
The following models are supported:
...
In NVDA, you can set the serial port to which the display is connected in the [Select Braille Display](#SelectBrailleDisplay "Select Braille Display") dialog.
These displays do not support NVDA's automatic background braille display detection functionality.

Following are the key assignments for EcoBraille displays.
Please see the [EcoBraille documentation](ftp://ftp.once.es/pub/utt/bibliotecnia/Lineas_Braille/ECO/ "EcoBraille documentation") for descriptions of where these keys can be found.
...
NVDA supports displays from [Nattiq Technologies](https://www.nattiq.com/ "Nattiq Technologies") when connected via USB.
...
[BRLTTY](https://www.brltty.app/ "BRLTTY") is a separate program which can be used to support many more braille displays.
In order to use this, you need to install [BRLTTY for Windows](https://www.brltty.app/download.html "BRLTTY for Windows").
...
Please see the [BRLTTY key binding lists](https://brltty.app/doc/KeyBindings/ "BRLTTY key binding lists") for information about how BRLTTY commands are mapped to controls on braille displays.
...
For computers where the Internet connection is disabled or not available, you can manually [download and install the USB to serial CH340 chip driver](https://www.wch-ic.com/downloads/CH341SER_EXE.html "download and install the USB to serial CH340 chip driver") to support this display over USB.
...
NVDA runs in secure mode when executed on [secure screens](#SecureScreens "secure screens"), unless the `serviceDebug` [system wide parameter](#SystemWideParameters "system wide parameter") is enabled.
To force NVDA to always start in secure mode, set the `forceSecureMode` [system wide parameter](#SystemWideParameters "system wide parameter").
NVDA can also be started in secure mode with the `-s` [command line option](#CommandLineOptions "command line option").

Secure mode disables:

- Saving configuration and other settings to disk
- Saving the gesture map to disk
- [Configuration Profile](#ConfigurationProfiles "Configuration Profile") features such as creation, deletion, renaming profiles etc.
- Loading custom configuration folders using [the `-c` command line option](#CommandLineOptions "the -c command line option")
- Updating NVDA and creating portable copies
- The [Add-on Store](#AddonsManager "Add-on Store")
- The [NVDA Python console](#PythonConsole "NVDA Python console")
- The [Log Viewer](#LogViewer "Log Viewer") and logging
- The [Braille Viewer](#BrailleViewer "Braille Viewer") and [Speech Viewer](#SpeechViewer "Speech Viewer")
...
NVDA runs in [secure mode](#SecureMode "secure mode") when executed on secure screens unless the `serviceDebug` [system wide parameter](#SystemWideParameters "system wide parameter") is enabled.

When running from a secure screen, NVDA uses a system profile for preferences.
NVDA user preferences can be copied [for use in secure screens](#GeneralSettingsCopySettings "for use in secure screens").
...
| `-s` | `--secure` | Starts NVDA in [Secure Mode](#SecureMode "Secure Mode") |
...
| None | `--enable-start-on-logon=True|False` | When installing, enable NVDA's [Use NVDA during Windows sign-in](#StartAtWindowsLogon "Use NVDA during Windows sign-in") |
...
To stop NVDA starting automatically, please refer to the options: [Start NVDA after I sign in](#GeneralSettingsStartAfterLogOn "Start NVDA after I sign in") and [Use NVDA during sign-in](#GeneralSettingsStartOnLogOnScreen "Use NVDA during sign-in") in NVDA's general settings.
...
| `serviceDebug` | DWORD | 0 (default) to disable, 1 to enable | If enabled, disables [Secure Mode](#SecureMode "Secure Mode") on [secure screens](#SecureScreens "secure screens"). Due to several major security implications, the use of this option is strongly discouraged |
| `forceSecureMode` | DWORD | 0 (default) to disable, 1 to enable | If enabled, forces [Secure Mode](#SecureMode "Secure Mode") to be enabled when running NVDA. |

## Further Information

If you require further information or assistance regarding NVDA, please visit the [NVDA web site](https://www.nvaccess.org "NVDA web site").
