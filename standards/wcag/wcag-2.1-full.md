---
ai_context: Complete WCAG 2.1 specification. Load wcag-2.1-quick-ref.md instead for
  most tasks.
domain:
- web
- documents
...
:   [Joshue O Connor](mailto:josh@interaccess.ie) (Invited Expert, InterAccess)
...
:   [public-agwg-comments@w3.org](mailto:public-agwg-comments@w3.org?subject=%5BWCAG21%5D%20YOUR%20TOPIC%20HERE) with subject line `[WCAG21] … message topic …` ([archives](https://lists.w3.org/Archives/Public/public-agwg-comments))
